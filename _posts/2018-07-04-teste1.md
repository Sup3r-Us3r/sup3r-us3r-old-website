...
<ul class="collapsible">
  ...
  <li>
    <div class="collapsible-header"><i class="material-icons">usb</i>Games</div>
  ...
  <li>
    <div class="collapsible-header"><i class="material-icons">arrow_downward</i>GRAVAR A .ISO VIA COMANDO DD "LINUX"</div>
